...
// Calcular media global solo de preguntas de puntuación
...
<div class="container-fluid px-4 py-4">
    ...
    <div class="row mb-3 align-items-center">
        ...
        <div class="col-auto d-flex gap-2">
            ...
            <a href="<?php echo RUTA_URL ?>/gestor_encuestas/editar/<?php echo $datos['encuesta']->id_encuesta ?>"
            ...
            <?php endif; ?>
            <?php endif; ?>
            <a href="<?php echo RUTA_URL ?>/otras_encuestas" class="btn btn-sm btn-outline-secondary">
...
function eliminarEncuesta(id){
    ...
    fetch('<?php echo RUTA_URL ?>/encuestas/eliminar', {
        ...
        if(ok) window.location='<?php echo RUTA_URL ?>/otras_encuestas';
...
function eliminarForzado(id, titulo){
    ...
    fetch('<?php echo RUTA_URL ?>/otras_encuestas/eliminar_forzado', {
        method:'POST',
        headers:{'Content-Type':'application/x-www-form-urlencoded'},
        body:'id_encuesta='+id
    }).then(r=>r.json()).then(data=>{
        if(data.ok) window.location='<?php echo RUTA_URL ?>/otras_encuestas';
