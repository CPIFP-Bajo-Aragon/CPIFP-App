...
<nav class="navbar navbar-expand-lg">
    <button class="navbar-toggler" type="button"
            data-bs-toggle="collapse" data-bs-target="#navMant">
        <span class="navbar-toggler-icon"></span>
    </button>

    <div class="collapse navbar-collapse" id="navMant">
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link <?php echo
                ...
                && strpos($current_url, 'add_incidencia') === false
                && strpos($current_url, 'ver_incidencia') === false)
                ? 'active' : '' ?>"
        ...
        <li class="nav-item">
            <a class="nav-link <?php echo strpos($current_url, 'filtro') !== false ? 'active' : '' ?>"
               href="<?php echo RUTA_URL ?>/incidencias/filtro">TODAS</a>
        </li>

        <!-- NUEVA INCIDENCIA -->
        <li class="nav-item">
            <a class="nav-link <?php echo strpos($current_url, 'add_incidencia') !== false ? 'active' : '' ?>"
               href="<?php echo RUTA_URL ?>/incidencias/add_incidencia">NUEVA INCIDENCIA</a>
        </li>
