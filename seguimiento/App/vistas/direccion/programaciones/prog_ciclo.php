...
<div class="table-responsive">
    <table class="table tabla-formato">
        ...
        <thead>
            <tr>
                <th colspan="12" style="vertical-align: middle;">
                    <div style="color:white; display: flex; justify-content: center;  height: 100%;">
                        <h5 style="margin-right: 20px;"><b><?php echo $datos['modulo'][0]->ciclo;?></b></h5>
                        <a class="nav-link" href="<?php echo RUTA_URL.'/programaciones/departamento/'.$datos['modulo'][0]->id_departamento;?>">
            ...
            <tr>
                <th class="text-center align-middle">Modulos</th>
                <th class="text-center align-middle">Codigo prog.</th>
                <th class="text-center align-middle">Curso</th>
                <th class="text-center align-middle">Edicion anterior</th>
                ...
                <th class="text-center">Revisada por jefe dto.<br>
                    <small>(solo nuevas)</small></th>
                <th class="text-center">Codigo verificacion <br>
                    <small>(solo nuevas)</small></th>
                <th class="text-center">Verficada profesor <br>
                    <small>(solo nuevas)</small></th>
                <th class="text-center align-middle" colspan="2">Opciones<i class="fas fa-cogs ms-2" ></i></th>
            </tr> 
        </thead>

        <tbody>
            <?php foreach ($datos['modulo'] as $dep) : ?>
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        foreach ($datos['programaciones_anio_anterior'] as $numero) {
                            if ($dep->id_modulo == $numero->id_modulo) {
                    ...
                    <td> <?php foreach($datos['profesor_anterior'] as $profesor_anterior):
                        if($profesor_anterior->id_modulo == $dep->id_modulo):?>
                    ...
                    foreach ($datos['profesor_modulo_ciclo'] as $profesor_modulo):
                        if ($profesor_modulo->cambia_programacion != -1 && $profesor_modulo->id_modulo == $dep->id_modulo):
                            foreach ($datos['programaciones_modulos_activas'] as $programaciones_activas):
                                if ($programaciones_activas->id_modulo == $dep->id_modulo && !$mostrado): ?>
                                    <span style="color: orangered; font-weight: bold">
                                        <?php echo $programaciones_activas->nueva == 1 ? 'Si' : 'No'; ?>
                                    </span>
                                    <?php
                                    $mostrado = true;
                                    break; 
