...
<link rel="stylesheet" href="<?php echo RUTA_URL ?>/public/css/estilos_usuario.css">
...
<div class="p-4 shadow-sm border rounded mt-5 tarjeta">
    ...
    <div class="mb-4 d-flex flex-wrap">
        <h3 class="mi_perfil">Mi perfil</h3>
    </div>


    <div class="row mt-2">
        <div class="input-group">
            <label for="nombre" class="input-group-text col-12 col-md-4 titulo_labels">Nombre y apellidos<sup>*</sup></label>
    ...
    <div class="row mt-4">
        <div class="input-group">
            <label for="email" class="input-group-text col-12 col-md-4 titulo_labels">Correo electronico<sup>*</sup></label>
    ...
    <form action="<?php echo RUTA_URL?>/usuario/cambiar_password/<?php echo $datos['usuarioSesion']->id_profesor?>" method="post">
        <div class="row mt-4">
            <div class="col-12 col-md-5 mb-4">
                <div class="input-group">
                    <label for="pass_new" class="input-group-text titulo_labels">Nuevo Password<sup>*</sup></label>
                    <input type="password" class="form-control" id="pass_new" name="pass_new" required>
                    <span class="input-group-text cursor_estilo" onclick="togglePassword()">👁️</span>
                </div>
            </div>
