...
<table class="table tabla-formato m-5">
        ...
        <thead>
            <tr>
                <th colspan="11" class="alineado_medio">
                    <div class="cabecera_btn_volver">
                        <h5 class="margen_derecho_20px"><b><?php echo $datos['modulos_ciclo'][0]->ciclo;?></b></h5>
            ...
            <tr>
                <th class="text-center align-middle">Módulos <i class="fas fa-book-open"></i></th>
                <th class="text-center align-middle">Curso <i class="fas fa-calendar-day"></i></th>
                <th class="text-center align-middle">Codigo programacion</th>
                ...
                <th class="text-center align-middle">Verificada <br>
            </tr>
        </thead>
        ...
        foreach ($datos['modulos_ciclo'] as $modulos) : ?>
                ...
                <tr>
                    ...
                    <!-- codigo programacion -->
                    <td class="text-center"><?php echo $modulos->codigo_programacion;?></td>
                    <!-- edicion curso anterior -->
                    <td class="text-center">
                        <?php foreach($datos['programaciones_ediciones_anteriores'] as $programaciones_anteriores):
                            if($programaciones_anteriores->id_modulo == $modulos->id_modulo):?>
                                <span><?php echo $programaciones_anteriores->num_version;?></span>
                        ...
                        if ($profesor_modulo->cambia_programacion != -1 && $profesor_modulo->id_modulo == $modulos->id_modulo):
                            foreach ($datos['programaciones_modulos_activas'] as $programaciones_activas):
                                if ($programaciones_activas->id_modulo == $modulos->id_modulo && !$mostrado): ?>
                                    <span class="texto_naranja_fuerte">
                            ...
                            <?php else: ?>
                                ...
                                <div class="modal fade" id="verificar<?php echo $modulos->id_modulo ?>" tabindex="-1" role="dialog" aria-labelledby="modalLabel<?php echo $modulos->id_modulo ?>" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <form method="post" action="<?php echo RUTA_URL?>/JDProgramaciones/verificar_programacion/<?php echo $modulos->id_modulo?>">
