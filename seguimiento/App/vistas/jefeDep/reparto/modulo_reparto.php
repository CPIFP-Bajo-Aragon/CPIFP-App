...
<div  class="card m-5 mb-5 shadow-lg" >
     ...
     <div class="card-header fondo_principal_texto_blanco">
        <div class="cabecera_btn_volver">
            <h5 class="margen_derecho_20px"><?php echo $datos['info_modulo'][0]->modulo;?></b></h5>
            <a class="nav-link" href="<?php echo RUTA_URL?>/JDReparto/modulos_ciclo/<?php echo $datos['info_modulo'][0]->id_ciclo;?>">
