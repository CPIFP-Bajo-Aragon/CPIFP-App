...
<div class="row m-4">
  <div class="col-12 col-md-5 d-flex flex-column flex-md-row gap-2">
    ...
    <a href="<?php echo RUTA_URL?>/PDiario_visualizar/<?php echo $datos['datos_modulo'][0]->id_modulo?>" class="btn btn-custom" id="visualizar">
...
<table class="table tabla-formato">
        ...
        <tbody>
              ...
              <tr style="font-size:12px; text-align:center; white-space: nowrap;" class="dias">

                    <!-- MUESTRA FECHA -->
                    <?php
                      $isInteractiva = ($calendario[$i]->tiene_clase == 'Sí' && $calendario[$i]->es_festivo == 'No');
                      $styleFecha = '';
                  ...
                  <?php if ($isInteractiva): ?>
                        <div data-bs-toggle="collapse" data-bs-target="#d[<?php echo $calendario[$i]->fecha . '@' . $temas->id_tema ?>]"
                          style="color: #0583c3; padding: 8px 6px; border: solid 1px #0583c3;
                          font-weight: bold; cursor: pointer; transition: all 0.3s ease;"
                          onmouseover="this.style.backgroundColor='#d6eaf8'; this.style.color='#0583c3'; this.style.borderColor='#d6eaf8';"
                          onmouseout="this.style.backgroundColor=''; this.style.color='#0583c3'; this.style.borderColor='#0583c3';">
                          <div>
                            <?php echo $calendario[$i]->fecha . ' (' . $calendario[$i]->dia_semana . ')'; ?>
                          </div>
                          <?php if ($calendario[$i]->id_evaluacion): ?>
                            <div><?php echo $calendario[$i]->evaluacion; ?></div>
                          <?php endif; ?>
                        </div>
                      <?php else: ?>
                  ...
                  <!-- COLUMNA HORAS DIA-->
                  <?php
                    $styleHoras = 'text-align: center; vertical-align: middle;'; 
                    if ($calendario[$i]->es_festivo == 'Sí') {
                        $styleHoras = 'background-color: #f8d7da;';
                    } elseif ($calendario[$i]->tiene_clase == 'No') {
                        $styleHoras = 'background-color: #dae0e5; font-size:12px; text-align:center;';
                    }
                  ?>
                  ...
                  <?php if ($calendario[$i]->tiene_clase == 'Sí' && $calendario[$i]->es_festivo == 'No'): ?>
                      <td>
                       <button type="button" class="btn" data-bs-toggle="collapse" style="background-color: #0583c3; color: white;" 
                       data-bs-target="#d[<?php echo $calendario[$i]->fecha . '@' . $temas->id_tema ?>]">+</button>
                      </td>
                  <?php else: ?>
